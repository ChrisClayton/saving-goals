...
export class AccountApi extends BaseLoopBackApi {
   ...
   * @param any id User id
   *
   * @param any fk Foreign key for targets
   *
   * @returns object An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public findByIdTargets(id: any, fk: any) {
    let method: string = "GET";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/accounts/:id/targets/:fk";
    let routeParams: any = {
      id: id,
      fk: fk
    };
   ...
   * This method returns no data.
   */
  public destroyByIdTargets(id: any, fk: any) {
    let method: string = "DELETE";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/accounts/:id/targets/:fk";
    let routeParams: any = {
   ...
   * </em>
   */
  public updateByIdTargets(id: any, fk: any, data: any = undefined) {
    let method: string = "PUT";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/accounts/:id/targets/:fk";
    let routeParams: any = {
   ...
   * </em>
   */
  public getTargets(id: any, filter: LoopBackFilter = undefined) {
    let method: string = "GET";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/accounts/:id/targets";
    let routeParams: any = {
   ...
   * </em>
   */
  public createTargets(id: any, data: any = undefined) {
    let method: string = "POST";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/accounts/:id/targets";
    let routeParams: any = {
   ...
   *  - `count` – `{number}` - 
   */
  public countTargets(id: any, where: any = undefined) {
    let method: string = "GET";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/accounts/:id/targets/count";
    let routeParams: any = {
      id: id
    };
    let postBody: any = {};
   ...
   * </em>
   */
  public createManyTargets(id: any, data: Array<any> = undefined) {
    let method: string = "POST";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/accounts/:id/targets";
    let routeParams: any = {
