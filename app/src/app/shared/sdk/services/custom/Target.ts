...
export class TargetApi extends BaseLoopBackApi {
  ...
  public create(data: any = undefined) {
    ...
    let urlParams: any = {};
    let result = this.request(method, url, routeParams, urlParams, postBody);
    return result.map((instance: Target) => new Target(instance));
  }
  ...
  public find(filter: LoopBackFilter = undefined) {
    ...
    if (filter) urlParams.filter = filter;
    let result = this.request(method, url, routeParams, urlParams, postBody);
    return result.map((instances: Array<Target>) =>
        instances.map((instance: Target) => new Target(instance))
    );
  }
